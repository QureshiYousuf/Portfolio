  ...
  return (
    <div className="relative flex flex-col items-center justify-center gap-5 p-8 max-sm:p-2">
      <div className="absolute flex justify-center items-center z-0 opacity-20">
        <img src="/images/IH/NewLogo.jpg" alt="IH - Logo" className="w-3/4" />
      </div>
      <p className="flex flex-col text-3xl max-sm:text-2xl text-center font-serif font-bold mb-8">
...
//   const details = [
//     `Instant Hub is an re-commerce platform where users can sell their used electronic gadgets like mobile phones, laptops, tablets,smartwatches, DSLRs etc to professional buyers.`,
//     `It also oﬀers Services such as mobile repairs, laptop repairs, painting, cleaning and more.`,
//     `Led the end-to-end development process of the Instant Hub using the MERN stack (MongoDB, Express.js, React.js, Node.js).`,
