...
const Education = () => {
  ...
  return (
    <div className="relative flex flex-col justify-center items-center py-10">
      ...
      ></div> */}
      <div
        className="z-0 w-0 h-0 absolute top-3/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-t-[250px] border-t-transparent 
                border-r-[490px] border-r-blue-600/30 border-b-[320px] border-b-transparent"
      ></div>
      <p className="top-0 text-4xl font-serif font-bold">Educations</p>
      <div className="flex flex-col gap-10 mt-10 space-y-20">
        {educations.map((education, i) => (
          ...
          >
            <p className="text-2xl font-bold pb-4">{education.qualification}</p>
            <p>{education.from}</p>
